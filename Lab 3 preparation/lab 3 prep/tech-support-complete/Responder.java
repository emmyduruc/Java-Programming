...
public class Responder
{
    ...
    /**
     *Generate responses based on provided words
     *@param words to use for generating the responses
    ...
    /**
     * Generate all responses from a given set of input words.
     * 
     * @param words  a set of words entered by the user
     * @return a concatanated string that should be displayed as the response
     */
    public String generateAllResponses(HashSet<String> words)
    {
         String response = "";
        for (String word : words) {
